...
// DEVCFG2
#pragma config FPLLIDIV = DIV_2         // System PLL Input Divider (4x Divider)
#pragma config FPLLRNG = RANGE_5_10_MHZ// System PLL Input Range (54-64 MHz Input)
#pragma config FPLLICLK = PLL_POSC      // System PLL Input Clock Selection (POSC is input to the System PLL)
#pragma config FPLLMULT = MUL_64       // System PLL Multiplier (PLL Multiply by 128)
#pragma config FPLLODIV = DIV_16        // System PLL Output Clock Divider (32x Divider)
...
#pragma config POSCGAIN = GAIN_LEVEL_2  // Primary Oscillator Gain Control bits (Gain Level 0 (Lowest))
